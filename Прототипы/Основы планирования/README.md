...
1) ваш представитель (инициалы, контакты) противоположного пола + адрес (жилое, рабочее, для отдыха)
1.1) инструменты 
1.1.1) продукты

<b>Третьим</b> пунктом определяем ценность каждой потребности:
- стоимость (заёмный - отдаём деньги, свой - принимаем)
- срок (цикличный, разово, промежуток)
- представитель (инициалы, контакты) для сделки + адрес (жилое, рабочее, для отдыха)
