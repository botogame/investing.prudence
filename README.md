...
В продолжении <a href="./Прототипы/Основа виртуализации/README.md">основ виртуализации</a> и <a href="./Прототипы/Исключение конфликтов/README.md">исключения конфликтов</a> данный репозиторий будет наполняться абзацами с названием "мысль №".
