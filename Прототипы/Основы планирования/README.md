...
<b>Вторым</b> пунктом для каждого местоположения определяем личные потребности в такой зависимости (как матрёшку собирать):
1) ваш представитель противоположного вам пола
1.1) помещение (жилое, рабочее, для отдыха)
1.1.1) инструменты развития 
1.1.1.1) продукты питания
