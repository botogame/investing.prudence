...
1.1) адрес представителя (своё, для покупки, гостевое)
1.1.1) инструменты
...
1.1.1.1) адрес представителя (магазин, услуги)
```
...
<b>Четвёртый</b> пункт завершает ваше планирование с помощью подписи, возможно виртуальной (тот же логотип). Это потвердит и закрепит взаимоотношение с вашими представителями.